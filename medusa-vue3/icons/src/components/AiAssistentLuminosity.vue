  ...
  <svg
      ...
      >
        ...
        >
          ...
          <circle cx="7.5" cy="5" r="3.9" stroke="url(#f)" stroke-width="0.2" />
        </g>
        <g
          filter="url(#g)"
          opacity="0.8"
        ...
        >
          ...
          <circle cx="10" cy="8.5" r="3.9" stroke="url(#i)" stroke-width="0.2" />
        </g>
        <g
          filter="url(#j)"
          opacity="0.8"
        ...
        >
          ...
          <circle cx="4" cy="4" r="3.9" stroke="url(#l)" stroke-width="0.2" />
        </g>
        <g
          filter="url(#m)"
          opacity="0.8"
        ...
        >
          ...
          <circle cx="4" cy="4" r="3.9" stroke="url(#o)" stroke-width="0.2" />
        </g>
        <g
          filter="url(#p)"
          opacity="0.8"
        ...
        >
          ...
          <circle cx="4" cy="4" r="3.9" stroke="url(#r)" stroke-width="0.2" />
        </g>
        <circle
          cx="7.5"
          cy="7.5"
        ...
        <defs>
          ...
          >
            <stop offset="0.2" stop-color="#C686FF" />
            <stop offset="0.8" stop-color="#8D99FF" />
          </linearGradient>
          <linearGradient
            id="c"
            x1="3.115"
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stop-color="#FF6778" stopOpacity="0.8" />
            <stop offset="1" stop-color="#fff" stopOpacity="0.1" />
          </linearGradient>
          <linearGradient
            id="e"
            x1="7.5"
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stop-color="#8D99FF" stopOpacity="0.1" />
            <stop offset="1" stop-color="#fff" stopOpacity="0.3" />
          </linearGradient>
          <linearGradient
            id="f"
            x1="11.5"
          ...
          >
            ...
            <stop offset="1" stop-color="#8D99FF" stopOpacity="0" />
          </linearGradient>
          <linearGradient
            id="k"
            x1="4"
          ...
          >
            ...
            />
            <feOffset dy="0.25" />
            <feGaussianBlur std-deviation="0.125" />
